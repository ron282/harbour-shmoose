...
Page {
    ...
    property int availability : shmoose.rosterController.getAvailability(conversationId)
    ...
    SilicaListView {
        ...
        delegate: Item {
            ...
            property string file : shmoose.getLocalFileForUrl(model.message)
            ...
            ListItem {
                ...
                Column {
                    ...
                    Label {
                        text: shmoose.addLinks(model.message)
                    ...
                    BackgroundItem {
                        ...
                        Row {
                            ...
                            Button {
                                ...
                                text: qsTr("Download")
                                onClicked: {
                                    shmoose.downloadFile(model.message, model.id);
                                }
                            }
                            Label {
                        ...
                        Label {
                            ...
                            Connections {
                                ...
                                onHttpDownloadFinished: {
                                    ...
                                    {
                                        file =  shmoose.getLocalFileForUrl(model.message);
                                    }
                                }
                            }
                        }
                ...
                menu: ContextMenu {
                    ...
                    MenuItem {
                        ...
                        visible: (model.msgstate == 5 && shmoose.canSendFile())
                        onClicked: {
                            shmoose.sendFile(conversationId, model.message);
                         }
                    }
                    MenuItem {
                        text: qsTr("Save")
